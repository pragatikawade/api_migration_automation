...
def test_001_invalid_auth_401_unauthorized(invalid_401_basic_auth_header, api_config):
    ...
    # MuleSoft request
    # -------------------------------
    mule_resp, mule_time = timed_request("GET", mule_url, invalid_401_basic_auth_header, params)
    try:
    ...
    # Azure request
    # -------------------------------
    azure_resp, azure_time = timed_request("GET", azure_url, invalid_401_basic_auth_header, params)
    try:
